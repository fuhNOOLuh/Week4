---
title: "R studio and R Markdown EDITED BY ME"
output:
...
2. When you click the **Knit** button a document will be generated that includes both content as well as the output of any embedded R code chunks within the document. 

3. To knit to pdf, you need to have LaTeX installed on your computer. If you don't already have it, you can install the tinytex package: install.packages("tinytex")
After that you'll need to restart Rstudio and run: tinytex::install_tinytex()

4. Try it with this Rmarkdown document, as you will need to create pdf outputs to submit your assignments. 
